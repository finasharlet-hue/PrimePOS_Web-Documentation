    ...
    items: [
      {
        ...
        type: "steps",
        nav: "Login  &gt;  Sign In",
        intro: "Every session starts at the PrimePOS login screen. Sign in with the username and password issued by your administrator to reach your dashboard.",
        content: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        intro: "This page displays every product registered in the system, giving quick access to product information so you can manage inventory and keep accurate records.",
        content: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        intro: "Sales Return records products that were sold to a customer and then returned.",
        content: [
